...
#
# prj_biss.tcl: Tcl script for re-creating project 'biss'
#
# Generated by Vivado on Fri Oct 27 16:08:58 +0800 2023
...
#
# 1. This project restoration tcl script (prj_biss.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "D:/Git/JXI/BISS-C/prj/zynq/biss/biss.srcs/sources_1/bd/biss/biss.bd"
#    "D:/Git/JXI/BISS-C/prj/zynq/biss/biss.srcs/sources_1/bd/biss/hdl/biss_wrapper.v"
#    "D:/Git/JXI/BISS-C/prj/zynq/biss/biss.srcs/constrs_1/io.xdc"
#
...
set orig_proj_dir "[file normalize "$origin_dir/../prj/zynq/biss"]"
...
set obj [get_filesets sources_1]
set_property -name "top" -value "biss_wrapper" -objects $obj
...
set file "[file normalize "$origin_dir/../../constraints/io.xdc"]"
...
set obj [get_filesets constrs_1]
set_property -name "target_constrs_file" -value "[get_files *io.xdc]" -objects $obj
set_property -name "target_part" -value "xc7z020clg400-1" -objects $obj
set_property -name "target_ucf" -value "[get_files *io.xdc]" -objects $obj
...
if {[string equal [get_runs -quiet impl_2] ""]} {
    create_run -name impl_2 -part xc7z020clg400-1 -flow {Vivado Implementation 2017} -strategy "SOLVE_MIG_TIMING_ERR" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
  set_property strategy "SOLVE_MIG_TIMING_ERR" [get_runs impl_2]
...
set obj [get_runs impl_2]
set_property -name "part" -value "xc7z020clg400-1" -objects $obj
set_property -name "strategy" -value "SOLVE_MIG_TIMING_ERR" -objects $obj
